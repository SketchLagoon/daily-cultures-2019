...
normal daily dietary routine.
                ...
                <li>
                  <img src={check} className="check" />
                  <p>
                  Our products taste great, are healthy and wholesome, made from
only 100% natural ingredients.
                ...
                <li>
                  <img src={check} className="check" />
                  <p>
                  Are suitable for Vegetarians and Vegans, so importantly offer
an alternative to dairy based probiotics.
                  </p>
                </li>
              </ul>
            </div>
